...
namespace do_ScrollView.extimplement
{
    ...
    /// </summary>
    public class scrollView_View : UserControl, doIUIModuleView
    {
        /// <summary>
        /// 每个UIview都会引用一个具体的model实例；
        /// </summary>
        private scrollView_Model model;
        ScrollViewer scroll = new ScrollViewer();
        public  scrollView_View()
        {
        }
        public void LoadView(doUIModule _doComponentUI)
        {
            this.model = _doComponentUI as scrollView_Model;
